...
namespace ProjectionOperators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //objTEST.DataSetLinq6();
            //objTEST.DataSetLinq7();
            //objTEST.DataSetLinq8();
            //objTEST.DataSetLinq9();
            //objTEST.DataSetLinq10();
            //objTEST.DataSetLinq11();
            //objTEST.DataSetLinq12();
            //objTEST.DataSetLinq13();
            //objTEST.DataSetLinq14();
            objTEST.DataSetLinq15();
            //objTEST.DataSetLinq16();
            //objTEST.DataSetLinq19();
        }
    }
    ...
    class LinqSamples
    {
        ...
        public void DataSetLinq10()
        {
            ...
            var digitOddEvens =
                ...
                where nums.Field<int>(0) < 5
                select new
                {
                    Digit = digits.Rows[nums.Field<int>("number")]["digit"], 
                    Even = (nums.Field<int>("number") % 2 == 0)
                };
        ...
        public void DataSetLinq12()
        {
            ...
            var numsInPlaces = numbers.Select((num, index) => new
            {
        ...
        public void DataSetLinq16()
        {
            ...
            var myOrders =
                from c in customers
                from o in orders
                where c.Field<string>("CustomerID") == c.Field<string>("CustomerID")
                && c.Field<DateTime>("OrderDate") >= new DateTime(1998, 0, 1)
                select new
                {
                    CustomerID = c.Field<string>("CustomerID"),
                    OrderID = c.Field<int>("OrderID"),
        ...
        public void DataSetLinq19()
        {
                ...
                customers.SelectMany(
                    (cust, custIndex) => 
                        ...
                        .Select(o => new
                        {
                            ...
                            CusomterID = cust.Field<string>("CustomerID"),
                            OrderID = o.Field<int>("OrderID")
                        })
                );
            ...
            {
                Console.WriteLine("Customer Index: " + c.CustomerIndex + " CustomerID : "  + c.CusomterID + 
