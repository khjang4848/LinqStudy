...
namespace JoinOperators
{
    ...
    class LinqSample
    {
        ...
        public void Linq102()
        {
            ...
            {
                Console.WriteLine("Country = {0}, Suppliers = {1}, Customer = {2}", item.Country, item.SupplierName, item.CustomerName);
            }
        }
        ...
        public void Linq106()
        {
            ...
            var custSuppliers =
                ...
                join sup in suppliers on cust.Country equals sup.Country
                into ss
                ...
                select new
                {
                    ...
                    CompnayName = cust.CompanyName,
                    SupplierName = s == null ? " No Suppliers" : s.SupplierName
                };

            foreach(var item in custSuppliers)
            {
                Console.WriteLine("{0}  ({1})  : {2}", item.CompnayName, item.Country, item.SupplierName);
            }
        }
